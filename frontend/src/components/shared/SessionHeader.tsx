        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3.5 flex-wrap">
            <div className="flex flex-col items-start gap-1">
              <span className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest leading-none">Primary Crisis</span>
              <Badge variant="secondary" className="bg-blue-100 text-blue-700 hover:bg-blue-100 border-blue-200 py-0.5 px-2.5 flex items-center gap-1.5 text-xs font-semibold">
                <Briefcase className="w-3.5 h-3.5" />
                {category}
              </Badge>
            </div>
            <div className="flex flex-col items-start gap-1 justify-end self-end">
